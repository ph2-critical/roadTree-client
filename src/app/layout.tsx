  ...
  return (
    <html lang="en">
      ...
      <body className={"h-screenWithoutHeader w-full dark:bg-gray-900"}>
        ...
        <script src="https://t1.kakaocdn.net/kakao_js_sdk/2.3.0/kakao.min.js" integrity="sha384-70k0rrouSYPWJt7q9rSTKpiTfX6USlMYjZUtr1Du+9o4cGvhPAWxngdtVZDdErlh"></script>
      </body>
    </html>
  );
}
