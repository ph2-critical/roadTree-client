export const PostCard = () => {
  return (
    <div className="flex flex-col w-2/3 ml-4 text-sm border-b border-gray-300 cursor-pointer h-52 md:ml-52 lg:w-1/2 p-9 hover:bg-modalbg">
      <div className="mb-3">
        <a className="mr-3 title-text">비전공자의 고민을 들어주세요!</a>
